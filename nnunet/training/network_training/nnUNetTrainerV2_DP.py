...
class nnUNetTrainerV2_DP(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=1, distribute_batch_size=False, fp16=False, max_num_epochs=1000, num_batches_per_epoch=250, num_val_batches_per_epoch=50):
        super(nnUNetTrainerV2_DP, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
                                                unpack_data, deterministic, fp16, max_num_epochs=max_num_epochs, num_batches_per_epoch=num_batches_per_epoch, num_val_batches_per_epoch=num_val_batches_per_epoch)
