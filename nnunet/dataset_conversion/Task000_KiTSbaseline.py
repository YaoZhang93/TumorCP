...
if __name__ == "__main__":
    ...
    train_id_range = range(0, 210)
    test_id_range = range(210, 210)
    train_dir = "/dfsdata2/zhongcheng_data/zhangyao_data/DB/kits19/ori_data/"
    test_dir = "/dfsdata2/zhongcheng_data/zhangyao_data/DB/kits19/ori_data/"

    output_folder = "../../data/nnUNet_raw_data/Task000_KiTSbaseline/"
