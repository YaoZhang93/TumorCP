...
if __name__ == "__main__":
    ...
    train_id_range = range(0, 100)
    test_id_range = range(100, 131)
    train_dir = "/dfsdata2/zhongcheng_data/zhangyao_data/DB/lits17/ori_data/"
    train_aug_dir = "/dfsdata2/zhongcheng_data/zhangyao_data/DB/dataaug/ori_data/lits_flip_rotate_scaling/"
    test_dir = "/dfsdata2/zhongcheng_data/zhangyao_data/DB/dataaug/ori_data/lits_flip_rotate_scaling/"

    output_folder = "../data/nnUNet_raw_data/Task101_LiTSrigid/"
